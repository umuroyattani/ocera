  ...
  const plans = [
    {
      ...
      features: [
        { name: "3 AI optimizations per month", included: true },
        { name: "3 subreddit suggestions per month", included: true },
        { name: "Basic content analysis", included: true },
        { name: "Community support", included: true },
        { name: "Manual posting only", included: true },
    ...
    },
    {
      ...
      features: [
        { name: "Unlimited AI optimizations", included: true },
        { name: "Unlimited subreddit suggestions", included: true },
        { name: "Advanced AI content analysis", included: true },
        { name: "Smart post scheduling", included: true },
        { name: "Detailed analytics dashboard", included: true },
        { name: "Rule compliance checker", included: true },
        { name: "Multi-subreddit posting", included: true },
        { name: "Priority support", included: true },
        { name: "API access", included: true },
        { name: "Custom AI prompts", included: true },
        { name: "Export analytics data", included: true },
      ],
          ...
          <div className="max-w-5xl mx-auto overflow-x-auto">
            <table className="w-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
              ...
              <tbody>
                {[
                  {
                    feature: "AI optimizations per month",
                    free: "3",
                    premium: "Unlimited",
                  },
                  {
                    feature: "Subreddit suggestions per month",
                    free: "3",
                    premium: "Unlimited",
                  },
                  {
                  ...
                  {
                    feature: "Multi-subreddit posting",
                    free: "❌",
                    premium: "✅",
                  },
                  {
                    feature: "Rule compliance checker",
                    free: "❌",
                    premium: "✅",
                  },
                  {
